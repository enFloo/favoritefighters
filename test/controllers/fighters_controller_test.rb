...
class FightersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fighter" do
    assert_difference("Fighter.count") do
      post fighters_url, params: { fighter: { first_name: @fighter.first_name, last_name: @fighter.last_name, weight_class: @fighter.weight_class } }
    end
  ...
  test "should update fighter" do
    patch fighter_url(@fighter), params: { fighter: { first_name: @fighter.first_name, last_name: @fighter.last_name, weight_class: @fighter.weight_class } }
